#############################################################################
# Makefile for building: stack_app
# Generated by qmake (3.1) (Qt 5.13.0)
# Project:  stack_app.pro
# Template: app
# Command: /home/cdp/Qt/5.13.0/gcc_64/bin/qmake -o Makefile stack_app.pro
#############################################################################
...
QMAKE         = /home/cdp/Qt/5.13.0/gcc_64/bin/qmake
DEL_FILE      = rm -f
...
INSTALL_DIR   = cp -f -R
QINSTALL      = /home/cdp/Qt/5.13.0/gcc_64/bin/qmake -install qinstall
QINSTALL_PROGRAM = /home/cdp/Qt/5.13.0/gcc_64/bin/qmake -install qinstall -exe
DEL_FILE      = rm -f
SYMLINK       = ln -f -s
DEL_DIR       = rmdir
MOVE          = mv -f
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = stack_app1.0.0
DISTDIR = /home/cdp/code/qt_project/stack_app/.tmp/stack_app1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS)    
AR            = ar cqs
...
DIST          = ../../../Qt/5.13.0/gcc_64/mkspecs/features/spec_pre.prf \
		...
		stack_app.pro  main.cpp \
		mystack.cpp \
		number_mode.cpp
QMAKE_TARGET  = stack_app
DESTDIR       = 
TARGET        = stack_app
...
Makefile: stack_app.pro ../../../Qt/5.13.0/gcc_64/mkspecs/linux-g++/qmake.conf ../../../Qt/5.13.0/gcc_64/mkspecs/features/spec_pre.prf \
		../../../Qt/5.13.0/gcc_64/mkspecs/common/unix.conf \
		../../../Qt/5.13.0/gcc_64/mkspecs/common/linux.conf \
		../../../Qt/5.13.0/gcc_64/mkspecs/common/sanitize.conf \
		../../../Qt/5.13.0/gcc_64/mkspecs/common/gcc-base.conf \
		...
		../../../Qt/5.13.0/gcc_64/mkspecs/features/lex.prf \
		stack_app.pro
	$(QMAKE) -o Makefile stack_app.pro
...
mystack.o: mystack.cpp mystack.h \
		common.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o mystack.o mystack.cpp

number_mode.o: number_mode.cpp mystack.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o number_mode.o number_mode.cpp
